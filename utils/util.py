...
def parse_arguments():
    ...
    parser.add_argument("--save_name", type=str, default="TeD_model", help="name of the experiment")

    parser.add_argument("--results_dir", type=str, default="./results", help="root directory to save results")
    parser.add_argument("--input_frames", type=int, default=21, help="# of input frames")
    ...
    parser.add_argument("--rstb_depths", type=int, default=[6, 6, 6, 6], nargs="+", help="depth of each Swin Transformer layer")
    ...
    parser.add_argument("--reg_loss_ratio", type=float, default=0.05, nargs="+", help="Regularization loss ratio")
...
def grad_imshow(inp, title = None):
    # Set caxis
    cmin = 0
    cmax = 1.0
    inp = inp.detach().numpy().transpose((0,1))
